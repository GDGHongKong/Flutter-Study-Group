...
class _GamePageState extends State<GamePage> {
  ...
  void jump() {
    print('jump');
    // TODO(jumpAndMove): check isJumping to avoid double jump

    // TODO(jumpAndMove): reset isJumping to true, time to 0, set marioY as initialHeight.

    // TODO(jumpAndMove): Do Jump here. uncomment the following code (line 71 to 86)
    ...
    //     // TODO(jumpAndMove): stop Mario continue falling
    //     //  Tips: cancel the timer, set isJumping to false and set marioY to 1
    //     //  which 1 is the aligment Y of the ground. Remember to call setState.
    //   } else {
    //     // TODO(jumpAndMove): update the MarioY whiling jumping, remember to call setState.
    //     // Tips: (initialHeight - height) is the new Aligment Y value for Mario
    //   }
    // });
  }
